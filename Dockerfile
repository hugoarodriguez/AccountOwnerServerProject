...
COPY ["./AccountOwnerServer/AccountOwnerServer.csproj", "src/AccountOwnerServer/"]
COPY ["./AccountOwnerServer.Data/AccountOwnerServer.Data.csproj", "src/AccountOwnerServer.Data/"]
COPY ["./AccountOwnerServer.Model/AccountOwnerServer.Model.csproj", "src/AccountOwnerServer.Model/"]

# run restore over API project - this pulls restore over the dependent projects as well
RUN dotnet restore "src/AccountOwnerServer/AccountOwnerServer.csproj"
